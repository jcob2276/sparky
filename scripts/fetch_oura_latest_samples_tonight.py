...
if oura_token:
    ...
    # Query from 20:00 UTC (22:00 local time) to now
    start_dt = "2026-08-01T19:00:00Z"
    ...
    try:
        ...
        with urllib.request.urlopen(req_hr) as resp:
            ...
            print(f"Total late samples fetched: {len(hr_data)}")
            
            tz = timezone(timedelta(hours=2))
            print("\n=======================================================")
            print("       OURA RING - LATEST HR SAMPLES TONIGHT (UTC+2)   ")
            print("=======================================================")
