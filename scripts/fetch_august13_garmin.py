...
with open("tmp/garmin_aug13_all_recent_acts.json", "w", encoding="utf-8") as f:
...
if today_acts:
    ...
    with open("tmp/garmin_aug13_summary.json", "w", encoding="utf-8") as f:
        json.dump(act, f, indent=2, ensure_ascii=False)
        
    try:
        laps = api.get_activity_splits(act_id)
        with open("tmp/garmin_aug13_laps.json", "w", encoding="utf-8") as f:
    ...
    try:
        ...
        with open("tmp/garmin_aug13_details.json", "w", encoding="utf-8") as f:
    ...
    try:
        ...
        with open("tmp/garmin_aug13_zones.json", "w", encoding="utf-8") as f:
    ...
    try:
        ...
        with open("tmp/garmin_aug13_weather.json", "w", encoding="utf-8") as f:
...
try:
    ...
    with open("tmp/garmin_aug13_sleep.json", "w", encoding="utf-8") as f:
...
try:
    ...
    with open("tmp/garmin_aug13_stats.json", "w", encoding="utf-8") as f:
...
try:
    ...
    with open("tmp/garmin_aug13_hrv.json", "w", encoding="utf-8") as f:
        json.dump(hrv, f, indent=2, ensure_ascii=False)
    print("Saved HRV data!")
except Exception as e:
    print("HRV error:", e)

try:
    user_summary = api.get_user_summary(today_str)
    with open("tmp/garmin_aug13_user_summary.json", "w", encoding="utf-8") as f:
        json.dump(user_summary, f, indent=2, ensure_ascii=False)
    print("Saved user summary!")
except Exception as e:
    print("User summary error:", e)
