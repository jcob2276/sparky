...
with open("tmp/garmin_aug27_all_recent_acts.json", "w", encoding="utf-8") as f:
...
if today_acts:
    ...
    with open("tmp/garmin_aug27_summary.json", "w", encoding="utf-8") as f:
        json.dump(act, f, indent=2, ensure_ascii=False)
        
    try:
        laps = api.get_activity_splits(act_id)
        with open("tmp/garmin_aug27_laps.json", "w", encoding="utf-8") as f:
    ...
    try:
        ...
        with open("tmp/garmin_aug27_details.json", "w", encoding="utf-8") as f:
    ...
    try:
        ...
        with open("tmp/garmin_aug27_zones.json", "w", encoding="utf-8") as f:
    ...
    try:
        ...
        with open("tmp/garmin_aug27_weather.json", "w", encoding="utf-8") as f:
...
try:
    ...
    with open("tmp/garmin_aug27_sleep.json", "w", encoding="utf-8") as f:
...
try:
    ...
    with open("tmp/garmin_aug27_stats.json", "w", encoding="utf-8") as f:
