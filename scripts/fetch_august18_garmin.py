...
with open("tmp/garmin_aug18_all_recent_acts.json", "w", encoding="utf-8") as f:
...
if today_acts:
    ...
    with open("tmp/garmin_aug18_summary.json", "w", encoding="utf-8") as f:
        json.dump(act, f, indent=2, ensure_ascii=False)
        
    try:
        laps = api.get_activity_splits(act_id)
        with open("tmp/garmin_aug18_laps.json", "w", encoding="utf-8") as f:
    ...
    try:
        ...
        with open("tmp/garmin_aug18_details.json", "w", encoding="utf-8") as f:
    ...
    try:
        ...
        with open("tmp/garmin_aug18_zones.json", "w", encoding="utf-8") as f:
    ...
    try:
        ...
        with open("tmp/garmin_aug18_weather.json", "w", encoding="utf-8") as f:
...
try:
    ...
    with open("tmp/garmin_aug18_sleep.json", "w", encoding="utf-8") as f:
...
try:
    ...
    with open("tmp/garmin_aug18_stats.json", "w", encoding="utf-8") as f:
