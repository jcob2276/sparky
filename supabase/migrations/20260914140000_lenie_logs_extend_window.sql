-- Fix lenieLogs: replace LIMIT 10 with a 60-day date filter.
-- The old LIMIT 10 caused undercounting when there were >10 events in 30 days,
-- making "ten tydzień" and "30 dni" stats wrong.
...
BEGIN
  ...
  SELECT jsonb_build_object(
    ...
    'lenieLogs', (
      ...
      FROM (
        -- FIX: was LIMIT 10 — now uses 60-day window so 30d/7d stats are always correct
